...
/* ORDEM (pedido direto do dono, 2026-08-08): "1 agentop, 2 sorteio,
   3 caloriasappbr, ylip e assim por diante" — os 4 produtos próprios mais
   fortes primeiro, na sequência exata que ele passou; o resto do portfólio
   (clientes + os 2 produtos próprios restantes) segue depois, na mesma
   ordem relativa que já tinha antes desta mudança. */
export const PROJECTS: Project[] = [
  ...
  // Adicionado 2026-08-08 (pedido direto do dono). Produto próprio (mesma
  // conta Agentop/contatoagentop — ver ylip_infra.md na memória). URL e
  // captura conferidas ao vivo nesta sessão: <title> real "YLIP —
  // Inteligência Logística". Descrição reaproveita só o MECANISMO que a
  // própria página descreve ("compara frete, parecer de IA aponta economia
  // e cobrança indevida") — sem repetir os números da tela (R$ 506 mil, 16+
  // transportadoras): são específicos de um snapshot e ficariam desatualizados
  // aqui, mesmo risco que já levou a remover número de mockup do resto do site.
  { id: "ylip", name: "YLIP", url: "https://ylip-frete.vercel.app/site", own: true, cat: ["Sistemas", "IA"], tags: ["Logística", "IA"], grad: "linear-gradient(150deg,#3B2FCC,#0A6C9E)", desc: "Compara frete entre transportadoras e usa IA para apontar economia e cobranças indevidas." },
